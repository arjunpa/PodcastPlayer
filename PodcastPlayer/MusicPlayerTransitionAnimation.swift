...
final class MusicPlayerTransitionAnimation : TransitionAnimatable {
    ...
    fileprivate weak var modalVC: NextControllerViewController!
    ...
    init(rootVC: ContainerViewController, modalVC: NextControllerViewController) {
        self.rootVC = rootVC
    ...
    func updateAnimation(_ transitionType: TransitionType, percentComplete: CGFloat) {
        if transitionType.isPresenting {
            ...
            self.rootVC.view.alpha = alpha + 0.5
